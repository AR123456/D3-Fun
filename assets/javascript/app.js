d3.queue()
  .defer(
    d3.csv,
    "/assets/data/co2/API_EN.ATM.CO2E.KT_DS2_en_csv_v2.csv",
    formatter
  )
  .defer(
    d3.csv,
    "/assets/data/methane/API_EN.ATM.METH.KT.CE_DS2_en_csv_v2.csv",
    formatter
  )
  .defer(
    d3.csv,
    "/assets/data/renewable/API_EG.FEC.RNEW.ZS_DS2_en_csv_v2.csv",
    formatter
  )
  .defer(
    d3.csv,
    "/assets/data/population/API_SP.POP.TOTL_DS2_en_csv_v2.csv",
    formatter
  )
  .defer(
    d3.csv,
    "/assets/data/urban_population/API_SP.URB.TOTL_DS2_en_csv_v2.csv",
    formatter
  )
